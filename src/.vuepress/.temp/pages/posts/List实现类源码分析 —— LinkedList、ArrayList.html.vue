...
<figure><img src="@source/posts/LinkedList.png" alt="LinkedList" tabindex="0" loading="lazy"><figcaption>LinkedList</figcaption></figure>
...
<figure><img src="@source/posts/ArrayList.png" alt="ArrayList" tabindex="0" loading="lazy"><figcaption>ArrayList</figcaption></figure>
<p>可见LinkedList既是List接口的实现也是Queue的实现（Deque），故其和ArrayList相比LinkedList支持的功能更多，其可视作队列来使用。</p>
...
<figure><img src="@source/posts/add.jpg" alt="add" tabindex="0" loading="lazy"><figcaption>add</figcaption></figure>
