...
<p>比如下面的竞态条件：</p>
<figure><img src="@source/posts/先更新数据库，再更新缓存.png" alt="先更新数据库，再更新缓存" tabindex="0" loading="lazy"><figcaption>先更新数据库，再更新缓存</figcaption></figure>
...
<figure><img src="@source/posts/先删除缓存，再更新数据库.png" alt="先删除缓存，再更新数据库" tabindex="0" loading="lazy"><figcaption>先删除缓存，再更新数据库</figcaption></figure>
...
<figure><img src="@source/posts/先更新数据库，再删除缓存.png" alt="先更新数据库，再删除缓存" tabindex="0" loading="lazy"><figcaption>先更新数据库，再删除缓存</figcaption></figure>
...
<figure><img src="@source/posts/del-key.png" alt="图片" tabindex="0" loading="lazy"><figcaption>图片</figcaption></figure>
<p>上面的做法的确点就是对业务代码有入侵，可以采用一种订阅数据库binlog的方式，用非业务代码完成对缓存的删除。</p>
<figure><img src="@source/posts/binlog-mq.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/posts/redis-mysql.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
