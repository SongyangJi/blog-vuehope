...
<figure><img src="@source/posts/thread-pools.png" alt="线程池的原理" tabindex="0" loading="lazy"><figcaption>线程池的原理</figcaption></figure>
<p>不过在JDK提供的线程池的原理比这个还要复杂些（真实的往往是复杂的）。</p>
<figure><img src="@source/posts/pool2.jpg" alt="工作流程图" tabindex="0" loading="lazy"><figcaption>工作流程图</figcaption></figure>
...
<p>描述为如下的工作流程图：</p>
<figure><img src="@source/posts/pool1.jpg" alt="线程池对任务的处理流程" tabindex="0" loading="lazy"><figcaption>线程池对任务的处理流程</figcaption></figure>
...
<figure><img src="@source/posts/ThreadPoolExecutor.png" alt="ThreadPoolExecutor" tabindex="0" loading="lazy"><figcaption>ThreadPoolExecutor</figcaption></figure>
