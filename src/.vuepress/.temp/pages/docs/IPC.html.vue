...
<p>具体来说，有下面三大类形式：</p>
<figure><img src="@source/docs/ipc.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/docs/pipe_with_two.jpg" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/docs/message_queue.jpg" alt="消息队列" tabindex="0" loading="lazy"><figcaption>消息队列</figcaption></figure>
<ol start="2">
<li>一个进程使用不同的数据包写入共享内存，并通过多个进程从中读取，即按消息类型。</li>
</ol>
<figure><img src="@source/docs/multiple_message_queue.jpg" alt="多个消息队列" tabindex="0" loading="lazy"><figcaption>多个消息队列</figcaption></figure>
