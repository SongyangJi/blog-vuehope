...
<p>否则表锁的代价太大。</p>
<figure><img src="@source/docs/granularity-hierarchy.png" alt="granularity-hierarchy" tabindex="0" loading="lazy"><figcaption>granularity-hierarchy</figcaption></figure>
...
<p>见下图，各种锁的兼容性矩阵。</p>
<figure><img src="@source/docs/lock-type-compatibility-matrix.png" alt="lock-type-compatibility-matrix" tabindex="0" loading="lazy"><figcaption>lock-type-compatibility-matrix</figcaption></figure>
...
<figure><img src="@source/docs/typemode.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>其他信息</li>
</ul>
